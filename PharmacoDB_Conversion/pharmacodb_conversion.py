...
input_file = './cell_line_pharmacodb_old.csv'
input_file1 = './Cellosaurus_pharmacodb_mapping_Final_File.csv'
output_file = './final_cell_table.csv'
                        ...
                        for value in txt_file1:
                            if(re.search(r'\cell_line\b', value)):
                                ...
                                if(value[0] == row[1] and value[1] == row[6].replace("\n", "") and value[2].replace("\n", "").replace("\r", "") == row[2]):
                                    ...
                                    break
                                elif(row[1] == 'NA' and value[1] == row[6].replace("\n", "") and value[2].replace("\n", "").replace("\r", "") == row[2]):
                                    csv_writer.writerow([row[0], value[0], row[2], row[3], row[4], row[5], row[6].replace("\n", "")])
                                    break
                                elif(value[0] != row[1] and value[1] == row[6].replace("\n", "") and value[2].replace("\n", "").replace("\r", "") == row[2]):
                                    csv_writer.writerow([row[0], value[0], row[2], row[3], row[4], row[5], row[6].replace("\n", "")])
                                    break
                                elif(row[1] == value[0] and value[1] != row[6].replace("\n", "") and value[2].replace("\n", "").replace("\r", "") != row[2]):
                                    csv_writer.writerow([row[0], 'NA', row[2], row[3], row[4], row[5], row[6].replace("\n", "")])
                                    break
